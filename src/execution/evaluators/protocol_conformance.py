...
from src.core.evidence import get_ast_annotations, get_ast_signature
from src.core.models import EvalContext, Evidence, Rule, RuleResult, RuleStatus
...
from src.protocols.signature_slots import signature_subject_annotation
