...
from src.config import Config, load_config, resolve_projects_config
from src.infrastructure.logging import configure_logging
from src.report.lazy import (
    build_report,
    generate_multi_target_report,
    generate_validation_report,
    get_multi_exit_code,
)
from src.validation_scope import VALIDATION_SCOPE_ALL, VALIDATION_SCOPES


def run_multi(*args: Any, **kwargs: Any) -> Any:
    from src.runner_multi import run_multi as _run_multi

    return _run_multi(*args, **kwargs)


def ProjectState(*args: Any, **kwargs: Any) -> Any:
    from src.state.project_state import ProjectState as _project_state
...
def _run_declaration_validation(
    ...
    from src.declaration_validation import (
