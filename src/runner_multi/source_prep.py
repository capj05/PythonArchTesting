...
from src.rules.compilation.orchestrator import compile_rules
...
from src.validation_scope import VALIDATION_SCOPE_ALL, filter_entities_for_scope


def _framework_version() -> str:
    try:
        return importlib.metadata.version("python-arch-testing")
    except Exception:
        return "unknown"
