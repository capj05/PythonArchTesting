...
from src.config.accessors import get_bool, get_int
from src.constants import ImportConstants
...
class ProjectStateImportsMixin:
    ...
    def import_module(self: "ProjectStateLike", module_path: str) -> ModuleType | None:
        ...
        if module_path in import_stack:
            ...
            from src.exceptions import ImportError as FrameworkImportError
