...
def _compile_python_modifier_rule(
    ...
    *,
    ...
    rule = Rule(
        ...
        fix_hints=(
            "Align the target class with the required Python modifier classification.",
            (
                "Use local abstract members or a recognized @final decorator "
                "when that is the intended contract."
            ),
        ),
        enabled=True,
    )
