...
def test_nom001_inherits_directly_from_evaluation_passes_for_direct_base() -> None:
    source_modules = [
        (
            "source_module.py",
            """
...
def test_nom001_inherits_directly_from_evaluation_fails_for_transitive_only_match() -> (
    None
):
    source_modules = [
        (
...
""",
    ...
    assert "target direct bases does not contain" in results[0].message


def test_nom001_inherits_directly_from_evaluation_fails_for_exact_same_type() -> None:
    source_modules = [
        (
            "source_module.py",
            """
...
def test_nom001_inherits_directly_from_evaluation_fails_for_unrelated_target() -> None:
    source_modules = [
        (
            "source_module.py",
            """
...
def test_nom001_inherits_directly_from_fails_for_unmatched_base_counterpart() -> None:
    source_modules = [
        (
            "source_module.py",
            """
